...
export default function Datenschutz() {
    return <div className="max-w-3xl mx-auto p-6">
        <h1 className="adsimple-112941166">Datenschutzerklärung</h1>
        <h2 id="einleitung-ueberblick" className="adsimple-112941166">Einleitung und Überblick</h2>
        <p>Wir haben diese Datenschutzerklärung (Fassung 29.01.2025-112941166) verfasst, um Ihnen gemäß der Vorgaben
            der <a className="adsimple-112941166"
                   href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=112941166#d1e2269-1-1"
                   target="_blank" rel="noopener">Datenschutz-Grundverordnung (EU) 2016/679</a> und anwendbaren
            ...
            <strong className="adsimple-112941166">Kurz gesagt:</strong> Wir informieren Sie umfassend über Daten, die
        ...
        <p>Datenschutzerklärungen klingen für gewöhnlich sehr technisch und verwenden juristische Fachbegriffe. Diese
            ...
            beschreiben. Soweit es der Transparenz förderlich ist, werden technische <strong
                className="adsimple-112941166">Begriffe leserfreundlich erklärt</strong>, Links zu weiterführenden
            Informationen geboten und <strong className="adsimple-112941166">Grafiken</strong> zum Einsatz gebracht. Wir
        ...
        <h2 id="anwendungsbereich" className="adsimple-112941166">Anwendungsbereich</h2>
        ...
        <ul className="adsimple-112941166">
            <li className="adsimple-112941166">alle Onlineauftritte (Websites, Onlineshops), die wir betreiben</li>
            <li className="adsimple-112941166">Social Media Auftritte und E-Mail-Kommunikation</li>
            <li className="adsimple-112941166">mobile Apps für Smartphones und andere Geräte</li>
        </ul>
        <p>
            <strong className="adsimple-112941166">Kurz gesagt:</strong> Die Datenschutzerklärung gilt für alle
        ...
        <h2 id="rechtsgrundlagen" className="adsimple-112941166">Rechtsgrundlagen</h2>
        <p>In der folgenden Datenschutzerklärung geben wir Ihnen transparente Informationen zu den rechtlichen
            ...
            auf EUR-Lex, dem Zugang zum EU-Recht, unter <a className="adsimple-112941166"
        ...
        <ol>
            <li className="adsimple-112941166">
                <strong className="adsimple-112941166">Einwilligung</strong> (Artikel 6 Absatz 1 lit. a DSGVO): Sie
            ...
            <li className="adsimple-112941166">
                <strong className="adsimple-112941166">Vertrag</strong> (Artikel 6 Absatz 1 lit. b DSGVO): Um einen
            ...
            <li className="adsimple-112941166">
                <strong className="adsimple-112941166">Rechtliche Verpflichtung</strong> (Artikel 6 Absatz 1 lit. c
            ...
            <li className="adsimple-112941166">
                <strong className="adsimple-112941166">Berechtigte Interessen</strong> (Artikel 6 Absatz 1 lit. f
        ...
        <ul className="adsimple-112941166">
            <li className="adsimple-112941166">In <strong className="adsimple-112941166">Österreich</strong> ist dies
                das Bundesgesetz zum Schutz natürlicher Personen bei der Verarbeitung personenbezogener Daten (<strong
                    className="adsimple-112941166">Datenschutzgesetz</strong>), kurz <strong
                    className="adsimple-112941166">DSG</strong>.
            </li>
            <li className="adsimple-112941166">In <strong className="adsimple-112941166">Deutschland</strong> gilt
                das <strong className="adsimple-112941166">Bundesdatenschutzgesetz</strong>, kurz<strong
                    className="adsimple-112941166"> BDSG</strong>.
            </li>
        </ul>
        ...
        <h2 id="kontaktdaten-verantwortliche" className="adsimple-112941166">Kontaktdaten des Verantwortlichen</h2>
        <p>Sollten Sie Fragen zum Datenschutz oder zur Verarbeitung personenbezogener Daten haben, finden Sie
            nachfolgend die Kontaktdaten des Verantwortlichen gemäß Artikel 4 Absatz 7 EU-Datenschutz-Grundverordnung
            (DSGVO):<br/>
            <span className="adsimple-112941166">Musterfirma GmbH<br/>
Max Mustermann<br/>
Musterstraße 47, 12312 Musterstadt, Österreich</span>
        ...
        <h2 id="speicherdauer" className="adsimple-112941166">Speicherdauer</h2>
        ...
        <h2 id="rechte-dsgvo" className="adsimple-112941166">Rechte laut Datenschutz-Grundverordnung</h2>
        ...
        <ul className="adsimple-112941166">
            <li className="adsimple-112941166">Sie haben laut Artikel 15 DSGVO ein Auskunftsrecht darüber, ob wir Daten
                ...
                <ul className="adsimple-112941166">
                    <li className="adsimple-112941166">zu welchem Zweck wir die Verarbeitung durchführen;</li>
                    <li className="adsimple-112941166">die Kategorien, also die Arten von Daten, die verarbeitet
                        werden;
                    </li>
                    <li className="adsimple-112941166">wer diese Daten erhält und wenn die Daten an Drittländer
                        übermittelt werden, wie die Sicherheit garantiert werden kann;
                    </li>
                    <li className="adsimple-112941166">wie lange die Daten gespeichert werden;</li>
                    <li className="adsimple-112941166">das Bestehen des Rechts auf Berichtigung, Löschung oder
                        Einschränkung der Verarbeitung und dem Widerspruchsrecht gegen die Verarbeitung;
                    </li>
                    <li className="adsimple-112941166">dass Sie sich bei einer Aufsichtsbehörde beschweren können (Links
                        zu diesen Behörden finden Sie weiter unten);
                    </li>
                    <li className="adsimple-112941166">die Herkunft der Daten, wenn wir sie nicht bei Ihnen erhoben
                        haben;
                    </li>
                    <li className="adsimple-112941166">ob Profiling durchgeführt wird, ob also Daten automatisch
                        ausgewertet werden, um zu einem persönlichen Profil von Ihnen zu gelangen.
                    </li>
                </ul>
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 16 DSGVO ein Recht auf Berichtigung der Daten, was
                bedeutet, dass wir Daten richtig stellen müssen, falls Sie Fehler finden.
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 17 DSGVO das Recht auf Löschung („Recht auf
                Vergessenwerden“), was konkret bedeutet, dass Sie die Löschung Ihrer Daten verlangen dürfen.
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 18 DSGVO das Recht auf Einschränkung der
                Verarbeitung, was bedeutet, dass wir die Daten nur mehr speichern dürfen aber nicht weiter verwenden.
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 20 DSGVO das Recht auf Datenübertragbarkeit, was
                bedeutet, dass wir Ihnen auf Anfrage Ihre Daten in einem gängigen Format zur Verfügung stellen.
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 21 DSGVO ein Widerspruchsrecht, welches nach
                Durchsetzung eine Änderung der Verarbeitung mit sich bringt.
                <ul className="adsimple-112941166">
                    <li className="adsimple-112941166">Wenn die Verarbeitung Ihrer Daten auf Artikel 6 Abs. 1 lit. e
                    ...
                    <li className="adsimple-112941166">Werden Daten verwendet, um Direktwerbung zu betreiben, können Sie
                    ...
                    <li className="adsimple-112941166">Werden Daten verwendet, um Profiling zu betreiben, können Sie
                        jederzeit gegen diese Art der Datenverarbeitung widersprechen. Wir dürfen Ihre Daten danach
                        nicht mehr für Profiling verwenden.
                    </li>
                </ul>
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 22 DSGVO unter Umständen das Recht, nicht einer
                ausschließlich auf einer automatisierten Verarbeitung (zum Beispiel Profiling) beruhenden Entscheidung
                unterworfen zu werden.
            </li>
            <li className="adsimple-112941166">Sie haben laut Artikel 77 DSGVO das Recht auf Beschwerde. Das heißt, Sie
        ...
        <p>
            <strong className="adsimple-112941166">Kurz gesagt:</strong> Sie haben Rechte &#8211; zögern Sie nicht, die
        ...
        <p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre
            ...
            Aufsichtsbehörde beschweren. Diese ist für Österreich die Datenschutzbehörde, deren Website Sie unter <a
                className="adsimple-112941166" href="https://www.dsb.gv.at/?tid=112941166" target="_blank"
                rel="noopener">https://www.dsb.gv.at/</a> finden. In Deutschland gibt es für jedes Bundesland einen
            Datenschutzbeauftragten. Für nähere Informationen können Sie sich an die <a className="adsimple-112941166"
        ...
        <h2 id="erklaerung-verwendeter-begriffe" className="adsimple-112941166">Erklärung verwendeter Begriffe</h2>
        ...
        <h2 id="auftragsverarbeiter" className="adsimple-112941166">Auftragsverarbeiter</h2>
        <p>
            <strong className="adsimple-112941166">Begriffsbestimmung nach Artikel 4 der DSGVO</strong>
        </p>
        <p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
        <blockquote>
            <p>
                <em>
                    <strong className="adsimple-112941166">„Auftragsverarbeiter“</strong> eine natürliche oder
                    juristische Person, Behörde, Einrichtung oder andere Stelle, die personenbezogene Daten im Auftrag
                    des Verantwortlichen verarbeitet;</em>
            </p>
        </blockquote>
        <p>
            <strong className="adsimple-112941166">Erläuterung:</strong> Wir sind als Unternehmen und Websiteinhaber für
            ...
            Unternehmen wie beispielsweise Google oder Microsoft sein.</p>
        <h2 id="einwilligung" className="adsimple-112941166">Einwilligung</h2>
        <p>
            <strong className="adsimple-112941166">Begriffsbestimmung nach Artikel 4 der DSGVO</strong>
        </p>
        <p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
        <blockquote>
            <p>
                <em>
                    <strong className="adsimple-112941166">„Einwilligung“</strong> der betroffenen Person jede
                    ...
                    personenbezogenen Daten einverstanden ist;</em>
            </p>
        </blockquote>
        <p>
            <strong className="adsimple-112941166">Erläuterung: </strong>In der Regel erfolgt bei Websites eine solche
        ...
        <h2 id="personenbezogene-daten" className="adsimple-112941166">Personenbezogene Daten</h2>
        <p>
            <strong className="adsimple-112941166">Begriffsbestimmung nach Artikel 4 der DSGVO</strong>
        </p>
        <p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
        <blockquote>
            <p>
                <strong className="adsimple-112941166">
        ...
        <p>
            <strong className="adsimple-112941166">Erläuterung:</strong> Personenbezogene Daten sind also all jene
            Daten, die Sie als Person identifizieren können. Das sind in der Regel Daten wie etwa:</p>
        <ul className="adsimple-112941166">
            <li className="adsimple-112941166">Name</li>
            <li className="adsimple-112941166">Adresse</li>
            <li className="adsimple-112941166">E-Mail-Adresse</li>
            <li className="adsimple-112941166">Post-Anschrift</li>
            <li className="adsimple-112941166">Telefonnummer</li>
            <li className="adsimple-112941166">Geburtsdatum</li>
            <li className="adsimple-112941166">Kennnummern wie Sozialversicherungsnummer, Steueridentifikationsnummer,
                Personalausweisnummer oder Matrikelnummer
            </li>
            <li className="adsimple-112941166">Bankdaten wie Kontonummer, Kreditinformationen, Kontostände uvm.</li>
        </ul>
        <p>Laut Europäischem Gerichtshof (EuGH) zählt auch Ihre <strong className="adsimple-112941166">IP-Adresse zu den
            ...
            Speichern einer IP-Adresse eine Rechtsgrundlage im Sinne der DSGVO. Es gibt auch noch sogenannte <strong
                className="adsimple-112941166">„besondere Kategorien“</strong> der personenbezogenen Daten, die auch
            besonders schützenswert sind. Dazu zählen:</p>
        <ul className="adsimple-112941166">
            <li className="adsimple-112941166">rassische und ethnische Herkunft</li>
            <li className="adsimple-112941166">politische Meinungen</li>
            <li className="adsimple-112941166">religiöse bzw. weltanschauliche Überzeugungen</li>
            <li className="adsimple-112941166">die Gewerkschaftszugehörigkeit</li>
            <li className="adsimple-112941166">genetische Daten wie beispielsweise Daten, die aus Blut- oder
                Speichelproben entnommen werden
            </li>
            <li className="adsimple-112941166">biometrische Daten (das sind Informationen zu psychischen, körperlichen
                oder verhaltenstypischen Merkmalen, die eine Person identifizieren können).<br/>
                Gesundheitsdaten
            </li>
            <li className="adsimple-112941166">Daten zur sexuellen Orientierung oder zum Sexualleben</li>
        </ul>
        <h2 id="profiling" className="adsimple-112941166">Profiling</h2>
        <p>
            <strong className="adsimple-112941166">Begriffsbestimmung nach Artikel 4 der DSGVO</strong>
        </p>
        <p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
        <blockquote>
            <p>
                <em>
                    <strong className="adsimple-112941166">„Profiling“</strong> jede Art der automatisierten
                    Verarbeitung personenbezogener Daten, die darin besteht, dass diese personenbezogenen Daten
                    verwendet werden, um bestimmte persönliche Aspekte, die sich auf eine natürliche Person beziehen, zu
                    ...
                    dieser natürlichen Person zu analysieren oder vorherzusagen;</em>
            </p>
        </blockquote>
        <p>
            <strong className="adsimple-112941166">Erläuterung:</strong> Beim Profiling werden verschiedene
            Informationen über eine Person zusammengetragen, um daraus mehr über diese Person zu erfahren. Im Webbereich
            wird Profiling häufig für Werbezwecke oder auch für Bonitätsprüfungen angewandt. Web- bzw.
            Werbeanalyseprogramme sammeln zum Beispiel Daten über Ihre Verhalten und Ihre Interessen auf einer Website.
            Daraus ergibt sich ein spezielles Userprofil, mit dessen Hilfe Werbung gezielt an eine Zielgruppe
            ausgespielt werden kann.</p>
        <p>&nbsp;</p>
        <h2 id="verantwortlicher" className="adsimple-112941166">Verantwortlicher</h2>
        <p>
            <strong className="adsimple-112941166">Begriffsbestimmung nach Artikel 4 der DSGVO</strong>
        </p>
        <p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
        <blockquote>
            <p>
                <em>
                    <strong className="adsimple-112941166">„Verantwortlicher“</strong> die natürliche oder juristische
        ...
        <p>
            <strong className="adsimple-112941166">Erläuterung:</strong> In unserem Fall sind wir für die Verarbeitung
            Ihrer personenbezogenen Daten verantwortlich und folglich der &#8220;Verantwortliche&#8221;. Wenn wir
            erhobene Daten zur Verarbeitung an andere Dienstleister weitergeben, sind
            diese &#8220;Auftragsverarbeiter&#8221;. Dafür muss ein &#8220;Auftragsverarbeitungsvertrag
            (AVV)&#8221; unterzeichnet werden.</p>
        <p>&nbsp;</p>
        <h2 id="verarbeitung" className="adsimple-112941166">Verarbeitung</h2>
        <p>
            <strong className="adsimple-112941166">Begriffsbestimmung nach Artikel 4 der DSGVO</strong>
        </p>
        <p>Im Sinne dieser Verordnung bezeichnet der Ausdruck:</p>
        ...
        <p>
            <strong className="adsimple-112941166">Anmerkung: </strong>Wenn wir in unserer Datenschutzerklärung von
        ...
        <p>Quelle: <a href="https://www.adsimple.at/datenschutz-generator/"
                      title="Datenschutzerklärung Generator Österreich">Datenschutzerklärung</a> erstellt
            mit dem Datenschutz Generator für Österreich von AdSimple</p>
